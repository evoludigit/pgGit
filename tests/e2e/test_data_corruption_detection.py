...
class TestHashIntegrityVerification:
    ...
    def test_detect_modified_commit_hash(self, db_e2e, pggit_installed):
    ...
    def test_detect_orphaned_hash_references(self, db_e2e, pggit_installed):
        ...
        orphaned_commit_id = db_e2e.execute_returning(
...
class TestReferentialIntegrity:
    ...
    def test_detect_broken_branch_commit_references(self, db_e2e, pggit_installed):
        """Test detection of commits referencing deleted branches"""
        # Create a temporary branch
        temp_branch_id = db_e2e.execute_returning(
    ...
    def test_detect_broken_object_parent_references(self, db_e2e, pggit_installed):
    ...
    def test_detect_broken_dependency_relationships(self, db_e2e, pggit_installed):
        ...
        obj1_id = db_e2e.execute_returning(
            "INSERT INTO pggit.objects (object_type, schema_name, object_name, branch_id) "
            "VALUES (%s, %s, %s, %s) RETURNING id",
            "TABLE", "public", "table1", main_id
        )[0]

        obj2_id = db_e2e.execute_returning(
            "INSERT INTO pggit.objects (object_type, schema_name, object_name, branch_id) "
            "VALUES (%s, %s, %s, %s) RETURNING id",
        ...
        dep_id = db_e2e.execute_returning(
    ...
    def test_verify_all_foreign_keys_valid(self, db_e2e, pggit_installed):
        ...
        invalid_commit_branches = db_e2e.execute("""
        ...
        invalid_object_parents = db_e2e.execute("""
        ...
        invalid_dependencies = db_e2e.execute("""
...
class TestStateConsistency:
    ...
    def test_detect_active_branch_with_no_commits(self, db_e2e, pggit_installed):
        """Test detection of ACTIVE branches without any commits"""
        # Create an ACTIVE branch (FIXED: UPPERCASE enum)
        empty_branch_id = db_e2e.execute_returning(
        ...
        empty_active_branches = db_e2e.execute("""
            SELECT b.id, b.name
    ...
    def test_verify_object_version_monotonic(self, db_e2e, pggit_installed):
        ...
        invalid_versions = db_e2e.execute("""
    ...
    def test_detect_duplicate_objects_same_branch(self, db_e2e, pggit_installed):
...
class TestDataTypeIntegrity:
    ...
    def test_verify_enum_values_valid(self, db_e2e, pggit_installed):
    ...
    def test_detect_null_in_not_null_columns(self, db_e2e, pggit_installed):
    ...
    def test_verify_timestamp_ordering(self, db_e2e, pggit_installed):
        ...
        invalid_timestamps = db_e2e.execute("""
...
class TestLogicalConsistency:
    ...
    def test_detect_circular_dependencies(self, db_e2e, pggit_installed):
        ...
        obj3_id = db_e2e.execute_returning(
            "INSERT INTO pggit.objects (object_type, schema_name, object_name, branch_id) "
            "VALUES (%s, %s, %s, %s) RETURNING id",
    ...
    def test_verify_merge_conflict_references_valid_merges(self, db_e2e, pggit_installed):
        ...
        orphaned_conflicts = db_e2e.execute(
        ...
        all_conflicts = db_e2e.execute("SELECT COUNT(*) FROM pggit.merge_conflicts")
        assert all_conflicts[0][0] >= 1, "Should have at least one conflict record"

    def test_detect_branch_history_without_parent_chain(self, db_e2e, pggit_installed):
        ...
        commit1_id = db_e2e.execute_returning(
        ...
        commit2_id = db_e2e.execute_returning(
            "INSERT INTO pggit.commits (branch_id, message, hash, parent_commit_hash) "
            "VALUES (%s, %s, %s, %s) RETURNING id",
        ...
        orphan_id = db_e2e.execute_returning(
            "INSERT INTO pggit.commits (branch_id, message, hash, parent_commit_hash) "
            "VALUES (%s, %s, %s, %s) RETURNING id",
        ...
        broken_chain_commits = db_e2e.execute("""
