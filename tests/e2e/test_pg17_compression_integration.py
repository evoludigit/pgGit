...
class TestCompressedTableTracking:
    ...
    def test_compressed_table_version_tracking(self, db, pggit_installed):
        ...
        db.execute("ALTER TABLE compressed_versions ALTER COLUMN large_data SET COMPRESSION lz4")
    ...
    def test_compression_preserved_in_schema_export(self, db, pggit_installed):
        ...
        db.execute("CREATE TABLE pg17_with_compression (id INT, data TEXT)")
        # Note: zstd compression requires PostgreSQL built with --with-zstd
        # Using lz4 which is more commonly available
        db.execute("ALTER TABLE pg17_with_compression ALTER COLUMN data SET COMPRESSION lz4")

        # Insert some data so table is tracked
        db.execute("INSERT INTO pg17_with_compression VALUES (1, 'test')")
        ...
        # Cleanup
        db.execute("DROP TABLE pg17_with_compression")
    ...
    def test_data_integrity_after_compression(self, db, pggit_installed):
        ...
        db.execute("ALTER TABLE pg17_integrity_test ALTER COLUMN original SET COMPRESSION lz4")
        db.execute("ALTER TABLE pg17_integrity_test ALTER COLUMN json_data SET COMPRESSION lz4")
        ...
        # Cleanup
        db.execute("DROP TABLE pg17_integrity_test")
    ...
    def test_mixed_compression_settings(self, db, pggit_installed):
        ...
        db.execute("ALTER TABLE lz4_compress ALTER COLUMN data SET COMPRESSION lz4")
        db.execute("ALTER TABLE zstd_compress ALTER COLUMN data SET COMPRESSION lz4")
...
class TestCompressionWithBranching:
    ...
    def test_compression_settings_in_branch_metadata(self, db, pggit_installed):
        ...
        db.execute("ALTER TABLE branch_compress ALTER COLUMN data SET COMPRESSION lz4")
    ...
    def test_compression_change_tracking(self, db, pggit_installed):
        ...
        # Add compression
        db.execute("ALTER TABLE compression_evolve ALTER COLUMN data SET COMPRESSION lz4")
...
class TestCompressionPerformance:
    ...
    def test_version_query_performance_on_compressed(self, db, pggit_installed):
        ...
        db.execute("ALTER TABLE perf_compressed ALTER COLUMN data SET COMPRESSION lz4")
    ...
    def test_insert_performance_with_compression(self, db, pggit_installed):
        ...
        db.execute("ALTER TABLE insert_perf ALTER COLUMN data SET COMPRESSION lz4")
    ...
    def test_schema_modification_performance_compressed(self, db, pggit_installed):
        ...
        db.execute("ALTER TABLE schema_perf ALTER COLUMN data SET COMPRESSION lz4")
...
class TestCompressionEdgeCases:
    ...
    def test_compression_on_table_without_toastable_columns(self, db, pggit_installed):
        ...
        db.execute("CREATE TABLE no_toast (id INT, count INT, note TEXT)")

        # Setting compression on TEXT column works
        db.execute("ALTER TABLE no_toast ALTER COLUMN note SET COMPRESSION lz4")
        ...
        # Insert data
        db.execute("INSERT INTO no_toast VALUES (1, 100, 'test note')")

        # Verify data works
        result = db.execute("SELECT count, note FROM no_toast WHERE id = 1")
    ...
    def test_compression_with_null_values(self, db, pggit_installed):
        ...
        db.execute("ALTER TABLE null_compress ALTER COLUMN data SET COMPRESSION lz4")
