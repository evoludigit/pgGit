...
class TestAdvancedDataQueries:
    ...
    def test_branch_commit_aggregation(self, db_e2e, pggit_installed):
    ...
    def test_cross_branch_data_consistency(self, db_e2e, pggit_installed):
    ...
    def test_complex_commit_filtering(self, db_e2e, pggit_installed):
    ...
    def test_data_transformation_query(self, db_e2e, pggit_installed):
    ...
    def test_conditional_aggregation(self, db_e2e, pggit_installed):
    ...
    def test_nested_subquery(self, db_e2e, pggit_installed):
    ...
    def test_set_operations(self, db_e2e, pggit_installed):
        ...
        db_e2e.execute("INSERT INTO public.set_a (id, value) VALUES (1, 'val1')")
        db_e2e.execute("INSERT INTO public.set_a (id, value) VALUES (2, 'val2')")
        db_e2e.execute("INSERT INTO public.set_b (id, value) VALUES (2, 'val2')")
        db_e2e.execute("INSERT INTO public.set_b (id, value) VALUES (3, 'val3')")
    ...
    def test_data_ordering_and_limits(self, db_e2e, pggit_installed):
    ...
    def test_group_by_having_clause(self, db_e2e, pggit_installed):
