...
class TestBackupRegistration:
    ...
    def test_register_backup_explicit_commit(self, db_e2e, pggit_installed):
    ...
    def test_register_backup_by_branch(self, db_e2e, pggit_installed):
    ...
    def test_register_backup_auto_detect(self, db_e2e, pggit_installed):
    ...
    def test_register_backup_invalid_commit(self, db_e2e, pggit_installed):
    ...
    def test_register_backup_with_snapshot(self, db_e2e, pggit_installed):
...
class TestBackupLifecycle:
    ...
    def test_complete_backup(self, db_e2e, pggit_installed):
    ...
    def test_fail_backup(self, db_e2e, pggit_installed):
    ...
    def test_complete_already_completed_backup(self, db_e2e, pggit_installed):
...
class TestBackupQueries:
    ...
    def test_list_backups_all(self, db_e2e, pggit_installed):
    ...
    def test_list_backups_by_commit(self, db_e2e, pggit_installed):
    ...
    def test_list_backups_by_branch(self, db_e2e, pggit_installed):
    ...
    def test_list_backups_by_status(self, db_e2e, pggit_installed):
        ...
        completed_id = db_e2e.execute_returning("""
            SELECT pggit.register_backup(
                'status-completed',
                'full',
                'pgbackrest',
        ...
        failed_id = db_e2e.execute_returning("""
            SELECT pggit.register_backup(
                'status-failed',
                'full',
                'pgbackrest',
    ...
    def test_get_backup_info(self, db_e2e, pggit_installed):
...
class TestBackupCommitRelationships:
    ...
    def test_multiple_backups_same_commit(self, db_e2e, pggit_installed):
    ...
    def test_backup_shows_all_branches(self, db_e2e, pggit_installed):
...
class TestBackupCoverageViews:
    ...
    def test_branch_backup_coverage(self, db_e2e, pggit_installed):
    ...
    def test_commit_backup_coverage(self, db_e2e, pggit_installed):
    ...
    def test_commit_with_no_backup_shows_risk(self, db_e2e, pggit_installed):
...
class TestBackupDependencies:
    ...
    def test_create_backup_dependency(self, db_e2e, pggit_installed):
        ...
        base_id = db_e2e.execute_returning("""
            SELECT pggit.register_backup(
                'dep-base-backup',
                'full',
                'pgbackrest',
        ...
        incr_id = db_e2e.execute_returning("""
            SELECT pggit.register_backup(
                'dep-incr-backup',
                'incremental',
                'pgbackrest',
...
class TestBackupVerifications:
    ...
    def test_record_verification(self, db_e2e, pggit_installed):
...
class TestBackupTags:
    ...
    def test_add_backup_tags(self, db_e2e, pggit_installed):
...
class TestBackupEdgeCases:
    ...
    def test_backup_location_validation(self, db_e2e, pggit_installed):
    ...
    def test_backup_type_validation(self, db_e2e, pggit_installed):
    ...
    def test_large_metadata(self, db_e2e, pggit_installed):
