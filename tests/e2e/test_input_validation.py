...
class TestBranchInputValidation:
    ...
    def test_create_branch_null_branch_name(self, db_e2e, pggit_installed):
        """Test create_branch with NULL branch name raises error."""
        with pytest.raises(Exception) as exc:
            db_e2e.execute("SELECT pggit.create_branch(NULL)")
    ...
    def test_create_branch_empty_branch_name(self, db_e2e, pggit_installed):
        """Test create_branch with empty string branch name."""
        # Now properly validates and rejects empty names
        with pytest.raises(Exception) as exc:
            db_e2e.execute("SELECT pggit.create_branch(%s)", "")
    ...
    def test_create_branch_sql_injection_attempt(self, db_e2e, pggit_installed):
    ...
    def test_create_branch_long_name(self, db_e2e, pggit_installed):
        ...
        too_long_name = "a" * 256
        with pytest.raises(Exception) as exc:
            db_e2e.execute("SELECT pggit.create_branch(%s)", too_long_name)
    ...
    def test_create_branch_special_characters(self, db_e2e, pggit_installed):
    ...
    def test_create_branch_nonexistent_parent(self, db_e2e, pggit_installed):
        """Test create_branch with non-existent parent branch."""
        with pytest.raises(Exception) as exc:
            db_e2e.execute("SELECT pggit.create_branch(%s, %s)",
    ...
    def test_create_branch_null_parent(self, db_e2e, pggit_installed):
...
class TestCommitInputValidation:
    ...
    def test_create_commit_null_branch_name(self, db_e2e, pggit_installed):
        """Test create_commit with NULL branch name."""
        with pytest.raises(Exception) as exc:
            db_e2e.execute("SELECT pggit.create_commit(NULL, %s, %s)",
    ...
    def test_create_commit_null_message(self, db_e2e, pggit_installed):
        """Test create_commit with NULL message."""
        # Now properly validates and rejects NULL messages
        with pytest.raises(Exception) as exc:
            db_e2e.execute("SELECT pggit.create_commit(%s, NULL::TEXT, %s)",
    ...
    def test_create_commit_empty_message(self, db_e2e, pggit_installed):
        """Test create_commit with empty message."""
        # Now properly validates and rejects empty messages
        with pytest.raises(Exception) as exc:
            db_e2e.execute("SELECT pggit.create_commit(%s, %s, %s)",
                      "test-branch", "", "SELECT 1")
    ...
    def test_create_commit_null_sql_content(self, db_e2e, pggit_installed):
    ...
    def test_create_commit_empty_sql_content(self, db_e2e, pggit_installed):
    ...
    def test_create_commit_invalid_sql_content(self, db_e2e, pggit_installed):
    ...
    def test_create_commit_sql_injection_in_message(self, db_e2e, pggit_installed):
    ...
    def test_create_commit_very_long_message(self, db_e2e, pggit_installed):
    ...
    def test_create_commit_unicode_in_fields(self, db_e2e, pggit_installed):
...
class TestMergeInputValidation:
    ...
    def test_merge_branches_null_source_branch(self, db_e2e, pggit_installed):
    ...
    def test_merge_branches_null_target_branch(self, db_e2e, pggit_installed):
    ...
    def test_merge_branches_nonexistent_source(self, db_e2e, pggit_installed):
    ...
    def test_merge_branches_nonexistent_target(self, db_e2e, pggit_installed):
        ...
        # Cleanup
        db_e2e.execute("DELETE FROM pggit.branches WHERE id = %s", source_id)
        print("✓ Non-existent target branch handled gracefully")

    def test_merge_branches_same_branch(self, db_e2e, pggit_installed):
    ...
    def test_merge_branches_null_message(self, db_e2e, pggit_installed):
        ...
        # Cleanup
        db_e2e.execute("DELETE FROM pggit.branches WHERE id IN (%s, %s)", source_id, target_id)

    def test_merge_branches_negative_ids(self, db_e2e, pggit_installed):
...
class TestMigrationInputValidation:
    ...
    def test_apply_migration_null_version(self, db_e2e, pggit_installed):
        """Test apply_migration with NULL version."""
        with pytest.raises(Exception) as exc:
            db_e2e.execute("SELECT pggit.apply_migration(NULL)")
    ...
    def test_apply_migration_empty_version(self, db_e2e, pggit_installed):
        """Test apply_migration with empty version string."""
        with pytest.raises(Exception) as exc:
            db_e2e.execute("SELECT pggit.apply_migration(%s)", "")
...
class TestBoundaryConditions:
    ...
    def test_integer_overflow_in_branch_id(self, db_e2e, pggit_installed):
    ...
    def test_extremely_long_text_fields(self, db_e2e, pggit_installed):
    ...
    def test_null_values_in_optional_parameters(self, db_e2e, pggit_installed):
    ...
    def test_empty_database_operations(self, db_e2e, pggit_installed):
