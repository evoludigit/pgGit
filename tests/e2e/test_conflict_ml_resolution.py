...
class TestMLConflictResolutionIntegration:
    ...
    def test_ml_pattern_prediction_during_merge(self, db_e2e, pggit_installed):
        ...
        result = db_e2e.execute("SELECT COUNT(*) FROM public.ml_merge_test")
    ...
    def test_conflict_pattern_learning_over_time(self, db_e2e, pggit_installed):
        ...
        db_e2e.execute("INSERT INTO public.conflict_pattern_test VALUES (1, 'base')")
    ...
    def test_adaptive_prefetch_during_conflict_resolution(self, db_e2e, pggit_installed):
    ...
    def test_semantic_conflict_with_ml_predictions(self, db_e2e, pggit_installed):
