...
class TestBranchingErrorHandling:
    ...
    def test_branch_name_validation(self, db, pggit_installed):
    ...
    def test_duplicate_branch_name_handling(self, db, pggit_installed):
        """Test handling of duplicate branch names"""
        branch_name = "duplicate-test-branch"

        # Create first branch
        id1 = db.execute_returning(
            "INSERT INTO pggit.branches (name) VALUES (%s) RETURNING id",
            branch_name
        )[0]
    ...
    def test_nonexistent_branch_operations(self, db, pggit_installed):
    ...
    def test_branch_with_invalid_characters(self, db, pggit_installed):
    ...
    def test_branch_state_after_error(self, db, pggit_installed):
    ...
    def test_branch_constraint_violations(self, db, pggit_installed):
    ...
    def test_concurrent_branch_operations_consistency(self, db, pggit_installed):
    ...
    def test_branch_deletion_with_commits(self, db, pggit_installed):
        ...
        try:
            db.execute("DELETE FROM pggit.branches WHERE id = %s", bid)
    ...
    def test_branch_name_length_limits(self, db, pggit_installed):
    ...
    def test_branch_id_sequence_integrity(self, db, pggit_installed):
